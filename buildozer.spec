...
source.include_exts = py,png,jpg,kv,atlas,gif,zip,json,css,ttf,java,glsl,wav
...
requirements = python3,kivy==2.0.0,https://github.com/kivymd/KivyMD/archive/master.zip,pygments,sdl2_ttf==2.0.15,pillow,ffpyplayer,requests,urllib3,chardet,idna
